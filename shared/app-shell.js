const icons = `
  <svg class="rx-icon-defs" aria-hidden="true">
    ...
    <symbol id="rx-terminal" viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="16" rx="2"></rect><path d="m7 9 3 3-3 3M13 15h4"></path></symbol>
  ...
  return `
    ...
    <aside class="rx-sidebar">
      ...
      <nav aria-label="Account navigation"><ul class="rx-side-nav">
        ...
        <li><a href="/terminal"><svg class="rx-icon"><use href="#rx-terminal"></use></svg><span>Terminal</span></a></li>
      </ul></nav>
