...
export function createAppShellMarkup({
  ...
  return `
    ...
    <header class="rx-topbar">
      ...
      <div class="rx-topbar-tools"><rx-home-search></rx-home-search><a class="rx-top-icon" href="/notifications" aria-label="Notifications"><svg class="rx-icon"><use href="#rx-bell"></use></svg></a><a class="rx-top-icon rx-robux-balance" href="/upgrades/robux" aria-label="Robux balance"><svg class="rx-icon"><use href="#rx-robux"></use></svg><span data-user-robux>--</span></a><a class="rx-top-icon" href="/my/account" aria-label="Settings"><svg class="rx-icon"><use href="#rx-gear"></use></svg></a></div>
    </header>
